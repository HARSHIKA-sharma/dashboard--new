    ...
    <header className="w-full font-sans shadow-md flex flex-col">
      ...
      <div className="bg-[#1f498c] text-white text-[11px] font-bold px-4 py-1.5 flex justify-between items-center hidden md:flex">
        <div className="flex divide-x divide-white/30">
          <a href="#" className="px-3 hover:underline">SCREEN READER ACCESS</a>
          <a href="#" className="px-3 hover:underline">SKIP TO MAIN CONTENT</a>
          <a href="#" className="px-3 hover:underline">SITEMAP</a>
          <a href="#" className="px-3 text-orange-300 hover:underline">OUTSOURCE KARMI PORTAL</a>
          <a href="#" className="px-3 hover:underline">हिंदी संस्करण</a>
          <span className="px-3 flex items-center justify-center bg-yellow-400 text-black">♿</span>
          <a href="#" className="px-3 hover:underline">VBTS</a>
        </div>
